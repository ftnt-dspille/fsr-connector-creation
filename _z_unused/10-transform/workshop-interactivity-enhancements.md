...
- ❌ Limited hands-on activities in early modules
- ❌ Few debugging/troubleshooting challenges
- ❌ Minimal peer collaboration opportunities
- ❌ Not enough "learn by fixing" scenarios
...
```markdown
## 🔨 Quick Practice: Analyze a Real Connector
...
- **Name:** Found in `info.json` → `"name": "virustotal"`
...
```markdown
## 🎯 Challenge: Trace the Execution Path
...
```markdown
## 🐛 Debug Challenge: Find and Fix the Bugs
...
```markdown
## 🏆 Connector Builder Achievements

Track your progress as you master connector development!

### Unlocked Achievements
- [ ] 📖 **Knowledge Seeker** - Complete all conceptual modules
- [ ] 🔨 **First Build** - Create and import your first connector
- [ ] ✅ **Health Check Hero** - Get green health check status
- [ ] 🎭 **Playbook Performer** - Run a successful test playbook
- [ ] 🐛 **Bug Hunter** - Fix 3 broken code examples
- [ ] 🎓 **API Explorer** - Test 5 different API endpoints
- [ ] 🚀 **Production Ready** - Complete connector with error handling
- [ ] 🧩 **Multi-Op Master** - Build connector with 3+ operations
- [ ] 📊 **Pagination Pro** - Handle paginated API responses
- [ ] 🔐 **Auth Architect** - Implement OAuth or complex auth
- [ ] 🎨 **UI Wizard** - Use dynamic/conditional fields
- [ ] 🔄 **Ingestion Engineer** - Build a working data ingestion connector
- [ ] 👨‍🏫 **Knowledge Sharer** - Help a peer debug their connector
- [ ] 🏅 **Workshop Champion** - Complete all labs with enhancements
...
```markdown
## 🔧 Lab Insert: Troubleshooting Challenge
...
```markdown
## 🔍 Self-Directed Learning: Connector Archaeology
...
```markdown
## ✏️ Knowledge Checkpoint: Connector Architecture
...
**Memory trick:** If you'd be annoyed entering it every single time → it's configuration!
{{% /expand %}}
...
It should NOT:
❌ Test every operation (too slow)  
❌ Check Python syntax (that happens on import)  
❌ Check FortiSOAR (not connector's job)
...
1. ✅ Add mini coding challenges in Python Primer
2. ✅ Add "Fill in the blanks" exercises in Lab 1
3. ✅ Add real API testing before building connectors
4. ✅ Add debugging scenarios
5. ✅ Add knowledge checkpoints with immediate feedback

### Phase 2 (Medium Impact, More Effort)
6. ✅ Add progressive complexity challenges
7. ✅ Add achievement tracking
8. ✅ Add "broken code" debugging exercises
9. ✅ Add connector archaeology exploration activity

### Phase 3 (Optional, For Group Training)
10. ✅ Add pair programming activities
11. ✅ Add peer review checklists
12. ✅ Add leaderboard/gamification
